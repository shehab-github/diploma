...
define([
    ...
    function (declare, BaseWidget, LocateButton, html, on, lang, jimuUtils, a11y) {
        var clazz = declare([BaseWidget], {
            ...
            _showTotlaWeightsDivs: function () {
                var div_landFillTotal = document.getElementById("div_landFillTotal");
                div_landFillTotal.style.display = "block";
                var div_workersTotal = document.getElementById("div_workersTotal");
                div_workersTotal.style.display = "block";
