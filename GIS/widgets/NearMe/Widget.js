            ...
            */
            onOpen: function () {
                if (this._isValidConfig) {
                    ...
                    navigator.geolocation.getCurrentPosition(lang.hitch(this, this._searchNearToUser));
                }
            },

            _searchNearToUser: function (position) {
                this._initWorkflow({
                    "feature": new Graphic(new Point(position.coords.longitude, position.coords.latitude, new SpatialReference({ wkid: 4326 }))),
